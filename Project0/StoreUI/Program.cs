        ...
        static void Main(string[] args)
        {
            ...
            while (true) {
                ...
                if (inp == 1) {
                    ...
                    //Managers require a password to log in
                    front.PageBreak(3);
                    Console.WriteLine ("===== Enter password to access manager functions");
                    Console.WriteLine ("<Enter password, or enter 0 to exit>");
                    
                    while (true) {
                        string pw = Console.ReadLine();
                        if (front.ValidatePassword(pw)) {
